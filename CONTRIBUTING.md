...
By contributing to the documentation, you're helping to make `aquia-inc/pre-commit-rust` more accessible and user-friendly for everyone. Thank you for your valuable contributions!
